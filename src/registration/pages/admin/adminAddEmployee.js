...
class AdminRegister extends Component {
    ...
    validate =(firstname,address,mobileNo,email,lastname,password,DOB,Gender,Eposition,specialization)=> {
        const errors = {
            firstname: '',
            address:'',
            mobileNo:'',
        ...
        if (this.state.touched.specialization && specialization.length < 3)
            errors.specialization = 'Specialization be >= 3 characters';
    ...
    onSubmit(e) {
        ...
        if (this.state.firstname.length < 3 || this.state.address.length < 3 ||
            ...
            this.validate(this.state.firstname,this.state.address,this.state.mobileNo,this.state.email,
                this.state.lastname,this.state.password,this.state.DOB,this.state.Gender,this.state.Eposition, this.state.specialization)
            ...
            <div>
                ...
                <Form className="admin_wrapper" onSubmit={this.onSubmit}>
                    ...
                    <div className="row">
                        ...
                        <FormGroup>
                        <Label for="exampleEmail">Specialization</Label>
                        <div>
                            <Input
                                type="text"
                                name="specialization"
                                id="exampleSpecialization"
                                placeholder=""
                                value={this.state.specialization}
                                onChange={this.onChange}
                                valid={errors.specialization === ''}
                                invalid={errors.specialization !== ''}
                                onBlur={this.handleBlur('specialization')}/>
                            <FormFeedback>{errors.specialization}</FormFeedback>
                        </div>
                    </FormGroup>
                        <FormGroup className="col-4">
